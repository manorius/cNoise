...
io.sockets.emit('red-line',{"data":99999});
  ...
  //console.log("RECEIVED FRAME FROM-> "+req.body.frameData);
  // WRITE FILE
  var frameNo = req.body.frameNo;
  console.log(frameNo);
if(frameNo==-1){ 
  folderName = "animation_"+req.body.dirName;
  fs.mkdirSync(folderName);
} 
else
{

  fs.writeFile(folderName+'/'+req.body.name+'.svg', req.body.frameData, function (err) {
  if (err) throw err;
